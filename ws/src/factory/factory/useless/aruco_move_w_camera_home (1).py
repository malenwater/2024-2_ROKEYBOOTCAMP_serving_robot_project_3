    ...
    def listener_callback(self, msg):
        ...
        for self.marker in msg.markers:
            if self.marker.id == self.target_marker_id:
                ...
                elif self.marker.pose.pose.position.z > 0.366:
                    self.publish_cmd_vel(0.06)
                elif self.marker.pose.pose.position.z > 0.266 :
...
def main(args=None):
    ...
    while(rclpy.ok()):
        ...
        if key_value == '1':          # move to cube
            ...
            point.positions = [0.0, -0.05522330836388308, -0.4049709280018093, 1.9987769666149904]
            print("point",point.positions)
            joint_pub.publish(trajectory_msg)
